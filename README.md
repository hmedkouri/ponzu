...
# Ponzu
[![Current Release](https://img.shields.io/github/release/hmedkouri/ponzu.svg)](https://github.com/hmedkouri/ponzu/releases/latest)
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/hmedkouri/ponzu)
[![CircleCI Build Status](https://circleci.com/gh/hmedkouri/ponzu.svg?style=shield)](https://circleci.com/gh/hmedkouri/ponzu/tree/master)
...
```
$ go get -u github.com/hmedkouri/ponzu/...
```
...
clone the 'github.com/hmedkouri/ponzu' package from over the network.
...
package by running `$ go get -u github.com/hmedkouri/ponzu/...` 
...
$ git clone https://github.com/hmedkouri/ponzu path/to/local/ponzu # (or your fork)
$ git checkout ponzu-dev

# install ponzu with go get or from your own local path
$ go get github.com/hmedkouri/ponzu/...
# or
...
# push to your origin:ponzu-dev branch and create a PR at hmedkouri/ponzu
$ git push origin ponzu-dev
# ... go to https://github.com/hmedkouri/ponzu and create a PR
```
